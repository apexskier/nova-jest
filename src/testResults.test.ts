...
const TreeViewTypedMock: jest.Mock<TreeView<unknown>> = jest
  .fn()
  .mockImplementation(mockTreeViewImplementation);
...
const IssueCollectionMock: jest.Mock<Partial<IssueCollection>> = jest
  .fn()
  .mockImplementation(() => ({
    clear: jest.fn(),
    append: jest.fn(),
